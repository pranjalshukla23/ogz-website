...
import AffiliateProgramHero from "../components/AffiliateProgramHero";
import AffiliateServices from "@/components/AffiliateServices";
import EarningProgram from "@/components/EarningProgram";
...
export default function AffiliateProgramHomePage() {
