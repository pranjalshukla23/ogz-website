...
export default function Security() {
  return (
    <div className='card flex flex-col justify-start items-center w-4/5 md:flex-row-reverse md:justify-between  mb-24 gap-12 md:gap-2 pb-4 md:pb-2 shadow-3xl rounded-md max-h-screen md:h-[279px]'>
      {/* image container */}
