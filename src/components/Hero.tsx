...
export default function Hero() {
  return (
    <div className='hero w-3/4 lg:w-11/12 h-screen flex flex-col-reverse lg:flex-row justify-center items-center mx-auto'>
      {/* left side */}
      <div className='w-3/4 flex flex-col justify-center items-start lg:items-start gap-y-4 p-6 pl-12'>
        <h1 className='text-lg lg:text-4xl text-orange-500 font-bold leading-snug tracking-wide'>
      ...
      {/* right side */}
      <div className='w-3/4 h-3/4 lg:w-1/3 relative'>
