...
export default function TimeLine() {
  return (
    <div className="hero w-11/12  p-4 mb-24">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
        <div className="heading ">
          <h3 className="text-orange-400">Timeline</h3>
        ...
        <li className="mb-10 ml-4">
          ...
          <div className="flex items-start justify-between gap-4">
            ...
            <div className="timeline-container">
              ...
              <br />
              <time className="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-orange-400">
                OGZ Team
              </time>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-orange-400">
                OGZ is born
              </h3>
              ...
              <a
                href="#"
                className="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-200 focus:text-blue-700 dark:bg-orange-400 dark:text-white dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700"
              >
      ...
      <div className="min-h-screen hidden md:flex flex-col justify-center sm:py-12  w-4/5 mx-auto">
        <div className="py-3 w-full px-2">
          <div className="relative text-gray-700 antialiased text-sm font-semibold ">
            <div className="hidden sm:block w-1 bg-amber-900 absolute h-full left-1/2 transform -translate-x-1/2 "></div>
            ...
            <div className="mt-6 sm:mt-0 sm:mb-12  relative">
              <div className="flex flex-col sm:flex-row items-center">
                ...
                <div className="rounded-full bg-bgBrown border-amber-900 border-4 w-8 h-8 absolute left-1/2 top-0 transform -translate-x-1/2 flex items-center justify-center"></div>
              </div>
            </div>
            ...
            <div className="mt-6 sm:mt-0 sm:mb-12">
              <div className="flex flex-col sm:flex-row items-center">
                ...
                <div className="rounded-md bg-amber-900 w-52 h-8 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center text-white  bottom-0">
                  <button className="items-center px-4 py-2 text-sm font-medium text-gray-900  rounded-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-200 focus:text-blue-700 dark:bg-amber-900 dark:text-white  dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700 w-full text-center">
                    View All
                  </button>
                </div>
              </div>
